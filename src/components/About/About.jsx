    ...
    <section className="about">
      <div className="about__container">
        ...
        <div className="about__bio">
          ...
          <h2>Eric Rosales</h2>
          <h3>CEO / Founder</h3>
          <p>An electrical engineer driven with ambition, supported by a foundation of over nearly a decade in the industry.</p> 
          <p>My academic and professional background leads the processes resulting in both reliable and robust designs.</p>
